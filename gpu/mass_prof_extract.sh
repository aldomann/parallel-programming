...
awk -f extract_npv.awk gpu-comp/lapGPU1-nvp.log > results/lapGPU1.dat
awk -f extract_npv.awk gpu-comp/lapGPU2-nvp.log > results/lapGPU2.dat
awk -f extract_npv.awk gpu-comp/lapGPU3-nvp.log > results/lapGPU3.dat
awk -f extract_npv.awk gpu-comp/lapGPU4-nvp.log > results/lapGPU4.dat
# awk -f extract_npv.awk gpu-comp/lapGPU5-nvp.log > results/lapGPU5.dat
